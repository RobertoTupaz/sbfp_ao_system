<div class="max-w-xl mx-auto">
		...
		<div id="schoolCard" class="bg-white rounded-xl shadow-md p-6 mb-6">
			<h2 class="text-lg font-semibold mb-4">{{ optional(collect($schools)->firstWhere('id', $school_id))->name }}</h2>
			<div class="flex flex-row gap-4 mt-4">
				<div class="flex flex-col items-center bg-green-50 border border-green-200 rounded-lg p-4 w-1/2 shadow">
					...
					<button type="button" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700 transition">Generate</button>
				</div>
				<div class="flex flex-col items-center bg-blue-50 border border-blue-200 rounded-lg p-4 w-1/2 shadow">
					...
					<button type="button" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition">Generate</button>
				</div>
			</div>
		</div>
	@endif
		...
		<form wire:submit.prevent="uploadExcel">
			<div class="mb-4">
				...
				<select id="district"
						...
						wire:change="userDistrictSelection($event.target.value)"
			...
			<div class="mb-4">
				...
				<select 
					...
					wire:change="userSchoolSelection($event.target.value)"
					class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
			...
			@if($school_id >= 1)
				<div class="mt-6 space-y-4">
					<div class="flex flex-col gap-2">
						...
						<div class="relative">
							...
							<label for="nfp" class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-blue-300 rounded-lg bg-blue-50 hover:bg-blue-100 hover:border-blue-400 cursor-pointer transition duration-200">
					...
					<div class="flex flex-col gap-2">
						...
						<div class="relative">
							...
							<label for="milk" class="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-amber-300 rounded-lg bg-amber-50 hover:bg-amber-100 hover:border-amber-400 cursor-pointer transition duration-200">
				...
				<button type="submit" class="mt-6 w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 rounded-lg hover:from-blue-700 hover:to-blue-800 transition duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2">
