<div class="space-y-4">
	...
	<div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
		...
		<a href="#" role="button" aria-label="Generate Consolidated Form 7" wire:click.prevent="generateConsolidatedForm7"
			class="group block bg-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition p-6 text-center cursor-pointer">
			<div class="flex items-center justify-center mb-4">
				...
				<div wire:loading.remove wire:target="generateConsolidatedForm7">
					<svg class="w-12 h-12 text-emerald-600 group-hover:text-emerald-700" xmlns="http://www.w3.org/2000/svg"
						fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
							d="M9 12h6m-6 4h6M7 8h10M5 6h14v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6z" />
					</svg>
		...
		<a href="#" role="button" aria-label="Generate Consolidated Form 2" wire:click.prevent="generateConsolidatedForm2"
			class="group block bg-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition p-6 text-center cursor-pointer">
			<div class="flex items-center justify-center mb-4">
		...
		<a href="#" role="button" aria-label="Generate Consolidated Baseline" wire:click.prevent="generateConsolidatedBaseline"
			class="group block bg-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition p-6 text-center cursor-pointer">
			<div class="flex items-center justify-center mb-4">
			...
			<div class="text-lg font-medium text-gray-800">
				<span wire:loading.remove wire:target="generateConsolidatedBaseline">Generate Consolidated Baseline</span>
		...
		<a href="#" role="button" aria-label="Generate Consolidated Midline" wire:click.prevent="generateConsolidatedMidline"
			class="group block bg-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition p-6 text-center cursor-pointer">
			<div class="flex items-center justify-center mb-4">
				...
				<div wire:loading.remove wire:target="generateConsolidatedMidline">
					<svg class="w-12 h-12 text-yellow-600 group-hover:text-yellow-700" xmlns="http://www.w3.org/2000/svg"
						fill="none" viewBox="0 0 24 24" stroke="currentColor">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
							d="M9 12h6m-6 4h6M7 8h10M5 6h14v12a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6z" />
					</svg>
