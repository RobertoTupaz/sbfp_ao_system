...
<script>
    (function() {
        ...
        window._generateForms_buttons_last = window._generateForms_buttons_last || {
            url: null,
            time: 0
        };
        ...
        function _gf_trigger_download(url) {
            try {
                if (!url) return;
                var now = Date.now();
                if (window._generateForms_buttons_last.url === url && (now - window._generateForms_buttons_last
                        .time) < 3000) {
